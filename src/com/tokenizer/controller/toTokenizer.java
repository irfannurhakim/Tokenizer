...
public class toTokenizer {
    ...
    /*public static void main(String[] args) {
        String sample = "laurel.adams@enron.com, cyndie.balfour-flanagan@enron.com, "+ 
	...
	"\nf..herod@enron.com, liz.hillman@enron.com, nathan.hlavaty@enron.com, "+
	"\nmarcie.holtman@enron.com, jim.homco@enron.com, cindy.horn@enron.com, "+
	"\nrahil.jafry@enron.com, tana.jones@enron.com, l..kelly@enron.com, "+
	"\ntroy.klussmann@enron.com, c..knightstep@enron.com, "+
	"\nvictor.lamadrid@enron.com, jenny.latham@enron.com, "+
	"\npaula.lee@enron.com, lisa.lees@enron.com, elsie.lew@enron.com, "+
	"\nh..lewis@enron.com, kori.loibl@enron.com, donna.lowry@enron.com, "+
	...
	"\news <.watson@enron.com>, patricia.weatherspoon@enron.com, "+
	...
	"\njeremy.wong@enron.com, rita.wynne@enron.com";
        ...
        //String sample2 = "<.watson@enron.com>";
        //sample2.replaceAll("<", "");
