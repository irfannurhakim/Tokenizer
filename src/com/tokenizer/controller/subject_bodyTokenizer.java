...
public class subject_bodyTokenizer {
    ...
    /**
     * author: Elisafina
     * method untuk melakukan tokenisasi untuk field subject dan body kemudian hasilnya ditampung pada hashmap
     * yang berisi term dan jumlah kemunculan term pada dokumen tertentu.
     * @param data
     * @return
     */
    public static HashMap<String, Integer> getListTerm(String data) {
        ...
        for (String s : ax) {
            ...
            if (s.matches("\\w+")) {
                ...
                if (!s.matches(EMAIL_PATTERN) || s.indexOf("http:")!=-1 || s.indexOf("www.")!=-1 || !s.matches("\\s+|\\W+")) {
    ...
    /**
     * author: Elisafina
     * method untuk memasukan sebuah token ke hashmap dengan pengecekan, jika token tersebut sudah pernah ada
     * maka value-nya akan ditambah 1
     * @param key
     * @param map
     */
